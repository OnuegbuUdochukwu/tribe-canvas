...
const artwork = {
    ...
    price: 25000,
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuD7FTCu5aJycp3SkbZkr1Fmhlltxx6fNl5mgZ2Q2_xDc5Hp8LqbcBO-1n2rsQrbsdwmLvzFLKV1HA20EnZn_hJVsmc2rsIE-H2lf5O2yppf85Wp-VKseALpgTGa77e-P6rBYF23qxzxzXODylX0fyNfccbg0gypeg3jXtQtP5gqQX5e0Y3bFtd9h9x8od4CJ2mUi9wOw9l5To6UOyB90wG0iM80BA52Gck9pThQaAVhZapBk5vw9NWwmxCJH-GCJ904DawXGuc9fDE",
...
const recommendations = [
    {
        ...
        artist: "Jide Adebayo",
        price: 22000,
        image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCyuwDF-hpFxbZFbEBgdcltMZMbvju8WU0aFRWI-a9qkyhIdTpGMARaZGJkut2FSMitCpn3MEYSGJwKXPHt_uHYDln1J-8JaIZy9a0piTvJIL8QB6JeCtY0sifMpx0YO1jD2sJcLsCVj-QFpfENDo_94-WssPATt3SRgWsvxZcNxZjOOmpGhzYrVvXhfRawMhOZQqOSS9LBAgGBx9Qwq5l5Sgx_3CpzuiSGKhx20ZuBeziQNMlsPiWDYpDOXcS9OR4Gyp40H0N5LCQ",
    },
    {
        title: "Coastal Breeze",
        artist: "Sade Bello",
        price: 28000,
        image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAkAS7aiAeyV9UezuBzL1pg3ATKOqbsysxaim1B6_u5Up0-gGYTf4-EENM2lPh6xBITdtuMWh8zFUfCGEYhzgAQBmu91Ec2j07voMRZGYO9tBX185YkUrqUQZrHkvsI2YlfQ2TMtUPMuyr-_0BrkhspyRkx9jgMnabLGmTb6-sUoLo_fBHS8Nc4EeVSb5kEk5sXbzYKg4jFF3NxPRt-p69qwRzJEJaRcHTMIAVaKclyDK6PHKyktunbpkB8M65T_jas51BVSD1QdUM",
    },
    {
        title: "Oasis Bloom",
        artist: "Femi Adekunle",
        price: 31000,
        image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA0mxjj0ZFy1pQHNzQ5-FDkdX_eOBJV0q_UNWjhCEamcVDHWE3OS5jqxHRKtvoHh_srOifHLoKs8p-KC673ZP0xT79qdMbaqeuZyMUadnshoh-28YJhCZAYkYjxw9hkemFOZ1IAj4id5AaTrz1XyWCm3Llry_gQ0jFmGVlaSO4yXTEbEjMvh3o3EvehVFYnjEvyGCd3H-_I7YNbD09YA4PNb9RjIubhmwnmW1I10LM1Nb6K-HifGTdu0QgXii2EYON4rgqL4WbXCug",
    },
];
                        ...
                        <div className="lg:col-span-4">
                            ...
                            <div className="mt-8">
                                <h2 className="text-2xl font-bold text-slate-900">
                                    ₦
                                    {artwork.price.toLocaleString("en-NG", {
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            d="M3 9.5V14.5C3 15.6046 3.89543 16.5 5 16.5H6.5M16 11.5L21 9V15L16 12.5V11.5ZM3 9.5L8 7V17L3 14.5V9.5ZM8 7L13 4.5V19.5L8 17V7Z"
                                            strokeLinecap="round"
                    ...
                    <div className="mt-16">
                        ...
                        <div className="py-10">
                            ...
                            {tab === "About the Artist" && (
                                <p className="text-base text-gray-700">
                                    Anya Okafor is a contemporary Nigerian
                                    artist known for her vibrant abstract works
                                    that reflect the pulse of urban life. Her
                                    art has been exhibited in galleries across
                                    Africa and Europe.
                                </p>
                            )}
                            {tab === "Shipping & Returns" && (
                                <p className="text-base text-gray-700">
                                    Shipping within Nigeria is free.
                                    International shipping rates apply. Returns
                                    are accepted within 14 days of delivery for
                                    undamaged artworks.
                                </p>
                            )}
                        </div>
                            ...
                            {recommendations.map((rec, idx) => (
                                <div className="group relative" key={idx}>
                                    ...
                                    <p className="mt-1 text-base font-medium text-gray-800">
                                        ₦
                                        {rec.price.toLocaleString("en-NG", {
                                            minimumFractionDigits: 2,
                                        })}
                                    </p>
                                </div>
