        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-[#0d171b]">Tribe Canvas</h1>
            </div>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="mb-8 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#0d171b]">Payouts</h2>
              <p className="mt-1 text-[#4c809a]">Manage your earnings and payout history.</p>
            </div>
          ...
          <div className="space-y-8">
            <section>
              <h3 className="mb-4 text-xl font-bold text-[#0d171b]">Pending Payouts</h3>
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-lg font-semibold text-[#0d171b]">${pendingPayout.amount.toFixed(2)}</p>
                    <p className="text-sm text-[#4c809a]">Estimated payout date: {pendingPayout.date}</p>
                  </div>
                </div>
              </div>
            </section>
            <section>
              <h3 className="mb-4 text-xl font-bold text-[#0d171b]">Completed Payouts</h3>
                    ...
                    {completedPayouts.map((payout, idx) => (
                      <tr key={idx}>
                        ...
                        <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                          <button className="text-[#1193d4] hover:text-blue-700">View</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
